...
MODES="${MODES:-reuse_off,reuse_on_bloom_on,reuse_on_bloom_off,reuse_on_bloom_on_no_hiv_disjoint,reuse_on_bloom_on_no_aggregate_disjoint,reuse_on_bloom_on_no_disjoint}"
